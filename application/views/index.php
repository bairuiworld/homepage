            ...
            <div class="grid">
                <div class="row">
                    <div class="span4 bg-color-blue">
                        <img src="<?php echo base_url();?>metro/images/simple.png" class="place-right" style="margin: 10px;"/>
                        <h2 class="fg-color-white">&nbsp;Simple</h2>
                    </div>

                    <div class="span4 bg-color-green">
                        <img src="<?php echo base_url();?>metro/images/grid.png" class="place-right" style="margin: 10px;"/>
                        <h2 class="fg-color-white">&nbsp;Sufficient</h2>
                    </div>

                    <div class="span4 bg-color-yellow">
                        <img src="<?php echo base_url();?>metro/images/responsive.png" class="place-right" style="margin: 10px;"/>
                ...
                <div class="row">
                    <div class="span4">
                        <div class="image-container bg-color-lighten" style="width: 100%">
                            <div style="height: 200px; overflow: hidden"><img src="<?php echo base_url();?>metro/images/spface.jpg" /></div>
                            <div class="overlay">
                    ...
                    <div class="span4">
                        <div class="image-container bg-color-lighten" style="width: 100%">
                            <div style="height: 200px; overflow: hidden"><img src="<?php echo base_url();?>metro/images/svface.jpg" /></div>
                            <div class="overlay">
                    ...
                    <div class="span4">
                        <div class="image-container bg-color-lighten" style="width: 100%">
                            <div style="height: 200px; overflow: hidden"><img src="<?php echo base_url();?>metro/images/vbface.jpg" /></div>
                            <div class="overlay">
                        ...
                        <table class="github-info" data-repo="olton/Metro-UI-CSS">
                            ...
                            <tr>
                                <td colspan="2" style="padding: 20px 0 0; border: 0;" class="right">
                                    <button class="image-button bg-color-pink fg-color-white" onclick="document.location.href='https://github.com/olton/Metro-UI-CSS'">View on Github<img class="bg-color-pinkDark" src="<?php echo base_url();?>metro/images/github.png"/></button>
                                </td>
                            </tr>
                            </tbody>
                        </table>
